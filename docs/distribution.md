...
## What this repository now prepares
...
My recommendation is to launch **Releases/GHCR, a personal Homebrew tap, a Scoop
bucket, and Unraid CA** first, then add **AUR and CasaOS/ZimaOS**. This covers the
